...
export default async function EditWorkoutPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const initialItems: WorkoutItem[] = sortedItems.map((item) => ({
    key: item.id,
  ...
  // and per-week prescriptions -- lets a block item show grouped under its
  // name instead of as an opaque reference. Same shape blocks/[id]/page.tsx
  // already assembles, mirrored here in one extra query.
  ...
  // Every cardio block this workout references, expanded with its full
  // detail -- same role as initialBlockDetails above.
