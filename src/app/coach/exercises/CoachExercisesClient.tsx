...
import clinicStyles from "../../clinic/clinic.module.css";
...
export default function CoachExercisesClient({ initialExercises }: { initialExercises: ExerciseRow[] }) {
  ...
  async function handleAdd() {
    ...
    try {
      ...
      setExercises((prev) =>
        [
          { exercise_id: data.exercise_id, name_clinical: name.trim(), body_site: bodySite || null, equipment: equipment || null, difficulty: difficulty || null },
          ...prev,
  ...
  return (
    <div>
      <div className={clinicStyles.card}>
        {!open ? (
          <button type="button" className={clinicStyles.buttonSecondary} onClick={() => setOpen(true)}>
            + Add an exercise
          </button>
        ) : (
          <>
